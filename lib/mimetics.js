...
class Mimetics {
   ...
   * @param {Object} scoringValues - Custom scoring values for different detection methods.
  ...
  constructor(
    ...
    // Initialize fileDefinitionScores in the constructor instead of using a class field
    this.fileDefinitionScores = {};
   ...
   */
  defaultResponse() {
    const definition = findLast(
      this.fileDefinitions,
      (def) => def.type === "octet-stream"
    );
